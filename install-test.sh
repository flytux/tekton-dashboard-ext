...
# for (( c=1; c<=$node_number; c++ )); do
#     read -p "IP는 무엇인가요? " node_ip
#     node_ips[$node_number-1]=$node_ip

#     read -p "Host명은 무엇인가요? " node_hostname
#     node_hostnames[$node_number-1]=$node_hostname

#     read -p "역할은 무엇안가요? " node_role
#     node_roles[$node_number-1]=$node_role
        
#     echo "================노드 정보================"
#     echo "($c)" ${node_hostnames[$node_number-1]} " : " ${node_ips[$node_number-1]} " : " ${node_roles[$node_number-1]}
# done
